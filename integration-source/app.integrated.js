...
(()=>{
      ...
      async function refreshSocialState({quiet=false}={}){
        ...
        if(firstError){
          if(socialSetupError(firstError)){socialAvailable=false;socialError='Run FINDAT-WRITING-DESK-SOCIAL-WORKSPACE-UPGRADE.sql in Supabase to activate reactions, discussions, follows and private messages.';if(!quiet)console.warn('FINDAT social workspace is awaiting its database upgrade.',firstError)}
        ...
        socialCache={reactions:results[0].data||[],bookmarks:results[1].data||[],follows:results[2].data||[],comments:results[3].data||[],messages:results[4].data||[]};
