...
## FINDAT Cloud shared documents

The `cloud` application now includes an optional Supabase-backed shared document system. See `cloud/README.md`, edit `cloud/cloud-config.js`, and run `cloud/supabase-findat-setup.sql` to enable shared uploads, website-wide viewing, embedded previews, public links, and storage-object cleanup on permanent deletion.
