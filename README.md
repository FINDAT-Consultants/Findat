...
The quick-access strip now includes **Cloud** immediately after **Developments**.
It launches the complete runtime from `Cloud/index.html` in a standalone,
screen-sized browser window. If pop-up windows are blocked, the launcher opens
FINDAT Cloud in the current browser tab.
