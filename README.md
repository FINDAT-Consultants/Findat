...
## Integrated FINDAT Cloud

- The **Cloud** quick-access feature appears between **Global Innovation** and **Security Window**.
- Its launcher and startup accents use FINDAT orange.
- It opens the complete uploaded FINDAT Cloud desktop in an isolated full-screen workspace.
- Cloud files, applications, workstations, profile tools, taskbar clock/calendar and fullscreen controls are retained.
- Use **Cloud → Exit Cloud** inside the cloud desktop, or press **Escape**, to return to FINDAT.
