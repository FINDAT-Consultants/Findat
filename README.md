...
## X1 ledger-PDF controls

The protected application includes the updated X1 ledger parser. It reads from page 1, preserves physical debit/credit column placement, excludes page footers and period/account totals, repairs OCR-damaged running balances, and checks the extracted movement against the opening and closing balances.
