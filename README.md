...
- The former **Exam Center** quick action is now **FINDAT Cloud**.
- FINDAT Cloud is included under `findat-cloud/` with its complete runtime assets.
- The Cloud opens in a fixed, full-viewport workspace above the platform header and menus.
- The Cloud's **Exit Cloud** and shutdown actions return the user to the FINDAT platform.
