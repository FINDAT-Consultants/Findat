...
begin
  ...
  if tg_op = 'INSERT' then
    ...
    if v_role = 'consultant' then
      ...
      -- Client accounts may write article text and upload a cover photo.
      -- Assignment and supporting-document attachments remain controlled by
      -- the Administrator/assigned Consultant workflow.
    ...
    if v_role = 'client' then
      ...
      -- Clients may replace or remove their own article cover photo.
