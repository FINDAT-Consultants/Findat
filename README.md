...
- A **Cloud** quick-access feature now appears immediately after **Developments**.
...
- Use **Close Cloud** in the parent toolbar or **Cloud → Exit Cloud** inside the cloud desktop to return to FINDAT.
