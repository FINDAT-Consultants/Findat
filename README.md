...
## FINDAT Cloud viewport integration

- Selecting **FINDAT Cloud** moves the Cloud workspace to the document root and makes it occupy the complete browser viewport.
- The normal FINDAT website header, dropdowns, login and registration layers are removed from rendering while Cloud is active.
- The extra integration toolbar is hidden because FINDAT Cloud already provides its own operating-system menu bar.
- Use **Cloud → Exit Cloud** inside the operating system to return to the FINDAT platform.
