...
See `FINDAT-EMAIL-OTP-NO-SMTP-SETUP.md`. The build includes password, Supabase-generated six-digit email codes, and Google sign-in. OTP delivery uses a signed Supabase Auth Send Email Hook and the Resend HTTPS API; no SMTP configuration is required.
