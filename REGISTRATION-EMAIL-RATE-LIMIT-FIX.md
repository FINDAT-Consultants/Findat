...
FINDAT now activates public Client registrations immediately. Email confirmation is not required for access when **Confirm email** is turned off, and this avoids consuming the limited built-in signup-email quota.
...
5. The new Client can enter FINDAT immediately; no Administrator approval is required.
